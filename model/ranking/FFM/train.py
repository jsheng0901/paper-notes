...
from notes.ranking.FFM.model import FieldAwareFactorizationMachineModel
from notes.utils.dataloader import create_dataset
from config import FFMModelConfig
...
def train(config):
    ...
    model = FieldAwareFactorizationMachineModel(field_dims, k_dims).to(device)
