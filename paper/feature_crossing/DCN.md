...
![DCN_模型结构图](./pics/DCN/DCN_模型结构图.png)
...
![DCN_cross_net_公式](./pics/DCN/DCN_2.2_cross_net_公式.png)
...
![DCN_cross_net_结构图](./pics/DCN/DCN_2.2_cross_net_结构图.png)
...
![DCN_模型表现对比](./pics/DCN/DCN_4.4_模型表现对比.png)
...
- 达到同样的 logloss 指标需要的参数个数
  - ![同样的损失不同参数个数对比](./pics/DCN/DCN_4.4_同样的损失不同参数个数对比.png)
- 同样参数下，能达到最小的 logloss 指标
  - ![同样参数下最小的损失对比](./pics/DCN/DCN_4.4_同样参数下最小的损失对比.png)
- 同样地超参数下，增加cross net 层数对 logloss 指标的影响，可以看出增加更高维度的特征交叉并不一定会对 logloss 指标有帮助。相反有时候会有反作用。
  - ![cross net层数对 logloss 指标的变化](./pics/DCN/DCN_4.4_cross_net层数影响.png)
