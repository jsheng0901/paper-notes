...
## 3.1 深度学习推荐模型的演化关系图
![深度学习推荐模型的演化关系图](./pics/chapter3/3.1_深度学习推荐模型的演化关系图.png)
...
## 3.2.2 AutoRec 模型的结构
![AutoRec模型结构](./pics/chapter3/3.2.2_AutoRec模型结构.png)
图中蓝色的神经元代表模型的k维单隐层，其中 k << m。V和W是参数矩阵，分别代表输入层到隐层，以及隐层到输出层的参数矩阵。输入层是物品的评分向量，比如协同过滤中的共现矩阵。V矩阵把输入投射到k维度，W矩阵再把投射过的返回来。
![AutoRec模型的重建函数](./pics/chapter3/3.2.2_AutoRec模型的重建函数.png)
![AutoRec模型的目标函数](./pics/chapter3/3.2.2_AutoRec模型的目标函数.png)
...
![AutoRec章节思维导图](./pics/chapter3/3.2.4_AutoRec章节思维导图.png)
...
![Deep_Crossing模型结构图](./pics/chapter3/3.3.2_Deep_Crossing模型结构图.png)
...
![Deep_Crossing章节思维导图](./pics/chapter3/3.3.3_Deep_Crossing章节思维导图.png)
...
- 从矩阵分解到NeuralCF，将矩阵分解中的内积互操作换成了神经网络MLP。本质上所有用户和物品的互操作层都可以被任意形式替代，也就是广义上矩阵分解模型。
  ![NeuralCF模型结构](./pics/chapter3/3.4.2_NeuralCF模型结构.png)
- NeuralCF混合模型，将不同互操作网络得到的向量拼接起来作为最终输出层的输入。
  ![NeuralCF混合模型结构](./pics/chapter3/3.4.2_NeuralCF混合模型结构.png)
...
![NerualCF章节思维导图](./pics/chapter3/3.4.3_NerualCF章节思维导图.png)
...
![PNN模型结构图](./pics/chapter3/3.5.1_PNN模型结构图.png)
...
![PNN章节思维导图](./pics/chapter3/3.5.3_PNN章节思维导图.png)
...
![Wide&Deep模型结构](./pics/chapter3/3.6.2_Wide&Deep模型结构.png)
...
![Wide&Deep模型详细结构](./pics/chapter3/3.6.2_Wide&Deep模型详细结构.png)
...
![Deep&Cross模型结构](./pics/chapter3/3.6.3_Deep&Cross模型结构.png)
...
![Wide&Deep章节思维导图](./pics/chapter3/3.6.4_Wide&Deep章节思维导图.png)
...
![FNN模型结构图](./pics/chapter3/3.7.1_FNN模型结构图.png)
...
![DeepFM模型结构图](./pics/chapter3/3.7.2_DeepFM模型结构图.png)
...
![NFM模型公式](./pics/chapter3/3.7.3_NFM模型公式.png)
![NFM模型结构图](./pics/chapter3/3.7.3_NFM模型结构图.png)
...
![AFM模型结构图](./pics/chapter3/3.8.1_AFM模型结构图.png)
...
![DIN模型结构图](./pics/chapter3/3.8.2_DIN模型结构图.png)
...
## 3.9.2 DIEN 模型的架构
![DIEN模型结构图](./pics/chapter3/3.9.2_DIEN模型结构图.png)
...
![DIEN中的AUGRU公式](./pics/chapter3/3.9.4_DIEN中的AUGRU公式.png)
...
## 3.10.1 深度强化学习推荐系统框架
![深度强化学习推荐系统框架](./pics/chapter3/3.10.1_深度强化学习推荐系统框架.png)
...
![DNQ模型结构图](./pics/chapter3/3.10.2_DNQ模型结构图.png)
...
## 3.10.3 DRN 的学习过程
![DRN模型学习过程](./pics/chapter3/3.10.3_DRN模型学习过程.png)
...
![DRN模型在线学习方法](./pics/chapter3/3.10.4_DRN模型在线学习方法.png)
...
下表为深度学习的推荐模型对比总结。
![深度学习的推荐模型对比总结](./pics/chapter3/3.11_总结.png)