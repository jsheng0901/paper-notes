...
## 1 简介
![DCN_V3_模型效果](./pics/DCN_V3/DCN_V3_模型效果.png)
...
## 3 模型架构
![DCN_V3_模型架构](./pics/DCN_V3/DCN_V3_模型架构.png)
...
![DCN_V3_模型输入层](./pics/DCN_V3/DCN_V3_3.1_模型输入层.png)
...
### SCN v3
![SCNv3 公式](./pics/DCN_V3/DCN_V3_3.2_SCN公式.png)
...
![DCNv3 公式](./pics/DCN_V3/DCN_V3_3.2_DCN公式.png)
...
### Self-Mask
![self mask 公式](./pics/DCN_V3/DCN_V3_3.2_self_mask公式.png)
...
![DCN_V3_融合层](./pics/DCN_V3/DCN_V3_3.3_融合层.png)
...
![DCN_V3_loss公式](./pics/DCN_V3/DCN_V3_3.3_loss公式.png)
...
![DCN_V3_loss权重公式](./pics/DCN_V3/DCN_V3_3.3_loss权重公式.png)

并联合训练它们以实现Tri-BCE loss:
![DCN_V3_tri_loss](./pics/DCN_V3/DCN_V3_3.3_tri_loss.png)
...
## 3.4.复杂度分析
![DCN_V3_复杂度分析](./pics/DCN_V3/DCN_V3_3.4_复杂度分析.png)
...
## 4.3.1 效率对比 (RQ2)
![DCN_V3_模型效率对比](./pics/DCN_V3/DCN_V3_4.3_模型效率对比.png)
...
![DCN_V3_消融实验结果](./pics/DCN_V3/DCN_V3_4.3.3_消融实验结果.png)
